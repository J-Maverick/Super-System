        ...
        public void _Initialize()
        {
            ...
            else
            {
                ...
                if (autoplayList)
                {
                    ...
                    if (autoplayOnLoad) if (tv.autoplayURL == null || string.IsNullOrWhiteSpace(tv.autoplayURL.Get()))
                        {
                            tv.autoplayURL = urls[sortView[nextSortViewIndex]];
                            tv.autoplayURLAlt = alts[sortView[nextSortViewIndex]];
                            pickNext();
                        }
                }
